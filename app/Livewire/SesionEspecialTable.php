...
final class SesionEspecialTable extends PowerGridComponent
{
    use WithExport;

    public string $tableName = 'sesion-especial-table';

    public function setUp(): array
    {
        return [
            PowerGrid::exportable(fileName: 'sesion_especial')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Orador de Orden', 'orador_de_orden')
                ->sortable()
                ->searchable()
                ->bodyAttribute('truncate max-w-xs'),
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::inputText('orador_de_orden')->operators(['contains']),
    ...
    public function actions(SesionEspecial $row): array
    {
        return [
            // Descargar PDF
            ...
            Button::add('edit')
                ...
                ->route('admin.sesion_especial.edit', ['sesion_especial' => $row->id])
