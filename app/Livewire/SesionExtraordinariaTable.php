...
final class SesionExtraordinariaTable extends PowerGridComponent
{
    use WithExport;

    public string $tableName = 'sesion-extraordinaria-table';

    public function setUp(): array
    {
        return [
            PowerGrid::exportable(fileName: 'sesion_extraordinaria')
    ...
    {
        return SesionExtraordinaria::query();
    }
    ...
    public function actions(SesionExtraordinaria $row): array
    {
        return [
            // Descargar PDF
            ...
            Button::add('edit')
                ...
                ->route('admin.sesion_extraordinaria.edit', ['sesion_extraordinaria' => $row->id])
