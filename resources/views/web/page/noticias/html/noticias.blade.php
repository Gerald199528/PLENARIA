                ...
                @forelse($noticias->where('tipo', 'video')->take(3) as $video)
                    <div class="card-hover bg-white rounded-xl overflow-hidden shadow-lg group">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-600 text-sm mb-3 leading-relaxed" style="text-align: justify; word-wrap: break-word; overflow-wrap: break-word; text-justify: inter-word; hyphens: auto;">
                                {{ Str::limit($video->contenido, 100) }}
                            </p>                        
                        </div>
                    </div>
                @empty
