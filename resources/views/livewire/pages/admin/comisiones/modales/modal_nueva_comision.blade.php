    ...
    <div class="w-full bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-500">
        ...
        <div class="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                <i class="fa-solid fa-handshake animate-bounce text-white w-6 h-6 sm:w-8 sm:h-9"></i>
                <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-wide">Nueva Comisión</h2>
            </div>
...
<div class="p-3 sm:p-4 md:p-6 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 dark:border-blue-400">
    <p class="text-blue-700 dark:text-blue-200 text-xs sm:text-sm md:text-base font-medium flex items-start gap-2 animate-fadeIn">
        ...
        <span>Aquí podrás <strong>crear nuevas comisiones</strong> de manera rápida y segura.</span>
    </p>
</div>
        <!-- Formulario -->
        <form wire:submit.prevent="saveComision" class="p-4 sm:p-8 space-y-6 sm:space-y-8">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-2 sm:gap-4 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <x-button slate wire:click="limpiar" label="Limpiar" icon="arrow-path"
                    class="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm bg-gray-500 text-white font-semibold rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400" />
