<x-modal name="confirmarModalSolicitud" max-width="10xl" x-on:abrir-confirmar-modal-solicitud.window="$openModal('confirmarModalSolicitud')">
    <div class="w-full bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-500">
        ...
        <form wire:submit.prevent="confirmar" class="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div class="relative group">
                <label for="tipo_solicitud" class="flex items-center gap-2 mb-2 text-sm sm:text-base font-semibold text-gray-700 dark:text-gray-300">
            ...
            <div x-data="{ max: 1000, texto: @entangle('respuesta') || '' }" class="relative group">
                <label for="respuesta" class="flex items-center gap-2 mb-2 text-sm sm:text-base font-semibold text-gray-700 dark:text-gray-300">
                    <x-icon name="chat-bubble-left-right" class="w-4 h-4 sm:w-5 sm:h-5" /> Respuesta/Observaciones (Obligatorio)
                </label>
                <textarea
                    id="respuesta"
