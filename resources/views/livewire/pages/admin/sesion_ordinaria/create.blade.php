...
new class extends Component {
    ...
    // Método de validación con alertas
    ...
    public function save()
    {
        ...
        try {         
            ...
            if ($this->ruta instanceof \Livewire\TemporaryUploadedFile || $this->ruta instanceof \Illuminate\Http\UploadedFile) {
                $originalFileName = $this->ruta->getClientOriginalName();                
                $filePath = $this->ruta->storeAs('sesion_ordinaria', $originalFileName, 'public');
                if (!$filePath) {
            ...
            $this->dispatch('showAlert', [
                'icon' => 'success',
                'title' => 'Éxito',
                'text' => 'Sesión ordinaria guardada correctamente.',
                'timer' => 2000,
                'timerProgressBar' => true,
            ]);
...
<div>
        ...
        <livewire:components.breadcrumb :breadcrumbs="[
            ...
            [
                'name' => 'Registrar Sesion Ordinaria',
            ],
        ]" />
    </x-slot>   

    @include('livewire.pages.admin.sesion_ordinaria.form.form', ['mode' => $mode, ])
</div>