        ...
        <div class="flex flex-col md:flex-row items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-700 to-indigo-900 text-white">
            <div class="flex items-center gap-3 mb-4 md:mb-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-white animate-bounce" viewBox="0 0 24 24" fill="currentColor">
        ...
        <!-- Formulario -->
        <form wire:submit.prevent="{{ $mode === 'edit' ? 'update' : 'save' }}">
...
<div class="space-y-6">
    ...
    <div class="relative group" x-data>
        <br>
        <label for="cedula"
            class="flex items-center gap-2 mb-1 text-base font-semibold text-gray-700 dark:text-gray-300">
            <x-icon name="identification" /> Cédula
        </label>
        <div
            class="flex transform transition-all duration-300 group-hover:scale-[1.0] focus-within:scale-[1.0 hover:shadow-lg rounded-2xl overflow-hidden">
            <span
                class="inline-flex items-center px-3 rounded-l-2xl border border-r-0 border-gray-300 dark:border-gray-600 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold text-base transition-all duration-300 group-hover:bg-gray-300 dark:group-hover:bg-gray-600">
                V
            </span>
            <input type="text" id="cedula" wire:model="cedula"
                ...
                class="block w-full p-4 text-base text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 rounded-r-2xl transform hover:scale-[1.01] focus:scale-[1.01] focus:-translate-y-0.5">
        </div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="relative group">
        ...
        <input type="text" id="nombre" wire:model="nombre" placeholder="Ej: Juan"
            class="block w-full p-4 text-base text-gray-900 dark:text-gray-100 
    ...
    <div class="relative group">
        <label for="apellido" class="flex items-center gap-2 mb-1 text-base font-semibold text-gray-700 dark:text-gray-300">
            <x-icon name="user" /> Apellido completo
        </label>
            ...
            <div class="relative group" x-data>
              ...
              <div class="flex transform transition-all duration-300 group-hover:scale-[1.01] focus-within:scale-[1.01] hover:shadow-lg rounded-2xl overflow-hidden">
                ...
                <input type="text" id="telefono" wire:model="telefono"
                  ...
                  class="block w-full p-4 text-base text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 rounded-r-2xl transform hover:scale-[1.00] focus:scale-[1.01] focus:-translate-y-0.5">
              </div>
            </div>
        <div class="relative group">
            <label for="cargo" class="flex items-center gap-2 mb-1 text-base font-semibold text-gray-700 dark:text-gray-300">
                <x-icon name="briefcase" /> Cargo
            </label>
            <input type="text" id="cargo" wire:model="cargo" placeholder="Ej: Cronista"
                class="block w-full p-4 text-base text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 group-hover:scale-[1.01] group-hover:shadow-lg">
        </div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
 ...
 <!-- Fecha de Ingreso -->
    <div class="relative group">
        <label for="fecha_ingreso" class="flex items-center gap-2 mb-1 text-base font-semibold text-gray-700 dark:text-gray-300">
            <x-icon name="calendar" /> Fecha de Ingreso
        </label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="relative group">
            <label class="flex items-center gap-2 mb-1 text-base font-semibold text-gray-700 dark:text-gray-300">
                <x-icon name="map" /> Estado
            </label>
            <select wire:model.live="estado_id"
                class="block w-full p-4 text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 group-hover:scale-[1.01] group-hover:shadow-lg">
...
<div x-data="{ max: 1000, texto: @entangle('perfil') || '' }" class="relative group">
    <label for="perfil"
        class="flex items-center gap-2 mb-1 text-base font-semibold text-gray-700 dark:text-gray-300">
        <x-icon name="chat-bubble-left-right" /> Perfil / Descripción del cronista
    </label>
    ...
    <div class="flex justify-between mt-2 text-sm text-gray-500 dark:text-gray-400">
        <p class="flex items-center gap-1"><x-icon name="information-circle" class="w-4 h-4 text-yellow-500" />
   ...
   @endif
        ...
        <x-button  info   type="sumbit"  label="{{ $mode === 'edit' ? 'Actualizar Cronista' : 'Guardar Cronista' }}" 
