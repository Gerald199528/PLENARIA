...
new class extends Component {
    ...
    public function mount($categorias_participacion)
    {
        $this->categoriaId = $categorias_participacion;
        $categoria = CategoriaParticipacion::findOrFail($categorias_participacion);
    ...
    {
        return [
            'nombre' => 'required|string|max:255|regex:/^[a-zA-ZÀ-ÿ\s\-]+$/|unique:categorias_participacion,nombre,' . $this->categoriaId,
    ...
    public function save()
    {
        ...
        try {
            $categoria = CategoriaParticipacion::findOrFail($this->categoriaId);
